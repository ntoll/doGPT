...
all:
	...
	@echo "make test - run the extensive unit test suite."
	@echo "make docs - use Sphinx to create project documentation."
	@echo "make dist - package up dogpt."
	@echo "make publish-test - upload dogpt to the test PyPI instance."
	@echo "make publish-live - uplaod dogpt to the main PyPI instance."

clean:
	rm -rf dogpt.egg-info
	rm -rf .pytest_cache
	rm -rf docs/_build
	rm -rf .eggs
	rm -rf build
